...
LoadConstStringLongIndex = Instruction('LoadConstStringLongIndex', 112, [Reg8, UInt32], globals())
...
GetArgumentsPropByVal = Instruction('GetArgumentsPropByVal', 124, [Reg8, Reg8, Reg8], globals())
...
CreateRegExp = Instruction('CreateRegExp', 127, [Reg8, UInt32, UInt32, UInt32], globals())
...
SwitchImm = Instruction('SwitchImm', 128, [Reg8, UInt32, Addr32, UInt32, UInt32], globals())
...
CreateGeneratorLongIndex = Instruction('CreateGeneratorLongIndex', 133, [Reg8, Reg8, UInt32], globals())
...
JNotLessEqualLong = Instruction('JNotLessEqualLong', 158, [Addr32, Reg8, Reg8], globals())
...
JNotLessEqualNLong = Instruction('JNotLessEqualNLong', 162, [Addr32, Reg8, Reg8], globals())
...
JGreaterEqualLong = Instruction('JGreaterEqualLong', 172, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqual = Instruction('JNotGreaterEqual', 173, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualLong = Instruction('JNotGreaterEqualLong', 174, [Addr32, Reg8, Reg8], globals())

JGreaterEqualN = Instruction('JGreaterEqualN', 175, [Addr8, Reg8, Reg8], globals())
JGreaterEqualNLong = Instruction('JGreaterEqualNLong', 176, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqualN = Instruction('JNotGreaterEqualN', 177, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualNLong = Instruction('JNotGreaterEqualNLong', 178, [Addr32, Reg8, Reg8], globals())
...
JStrictNotEqualLong = Instruction('JStrictNotEqualLong', 186, [Addr32, Reg8, Reg8], globals())
