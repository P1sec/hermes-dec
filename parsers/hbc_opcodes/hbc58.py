...
CreateGeneratorClosure = Instruction('CreateGeneratorClosure', 95, [Reg8, Reg8, UInt16], globals())

CreateGeneratorClosureLongIndex = Instruction('CreateGeneratorClosureLongIndex', 96, [Reg8, Reg8, UInt32], globals())
...
LoadConstStringLongIndex = Instruction('LoadConstStringLongIndex', 105, [Reg8, UInt32], globals())
...
GetArgumentsPropByVal = Instruction('GetArgumentsPropByVal', 116, [Reg8, Reg8, Reg8], globals())
...
CreateRegExp = Instruction('CreateRegExp', 119, [Reg8, UInt32, UInt32, UInt32], globals())
...
SwitchImm = Instruction('SwitchImm', 120, [Reg8, UInt32, Addr32, UInt32, UInt32], globals())
...
CreateGeneratorLongIndex = Instruction('CreateGeneratorLongIndex', 125, [Reg8, Reg8, UInt32], globals())
...
JNotLessEqualLong = Instruction('JNotLessEqualLong', 147, [Addr32, Reg8, Reg8], globals())
...
JNotLessEqualNLong = Instruction('JNotLessEqualNLong', 151, [Addr32, Reg8, Reg8], globals())
...
JGreaterEqualLong = Instruction('JGreaterEqualLong', 161, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqual = Instruction('JNotGreaterEqual', 162, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualLong = Instruction('JNotGreaterEqualLong', 163, [Addr32, Reg8, Reg8], globals())

JGreaterEqualN = Instruction('JGreaterEqualN', 164, [Addr8, Reg8, Reg8], globals())
JGreaterEqualNLong = Instruction('JGreaterEqualNLong', 165, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqualN = Instruction('JNotGreaterEqualN', 166, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualNLong = Instruction('JNotGreaterEqualNLong', 167, [Addr32, Reg8, Reg8], globals())
...
JStrictNotEqualLong = Instruction('JStrictNotEqualLong', 175, [Addr32, Reg8, Reg8], globals())
