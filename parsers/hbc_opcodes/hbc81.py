...
LoadConstStringLongIndex = Instruction('LoadConstStringLongIndex', 108, [Reg8, UInt32], globals())
...
GetArgumentsPropByVal = Instruction('GetArgumentsPropByVal', 120, [Reg8, Reg8, Reg8], globals())
...
CreateRegExp = Instruction('CreateRegExp', 123, [Reg8, UInt32, UInt32, UInt32], globals())
...
SwitchImm = Instruction('SwitchImm', 124, [Reg8, UInt32, Addr32, UInt32, UInt32], globals())
...
CreateGeneratorLongIndex = Instruction('CreateGeneratorLongIndex', 129, [Reg8, Reg8, UInt32], globals())
...
JNotLessEqualLong = Instruction('JNotLessEqualLong', 154, [Addr32, Reg8, Reg8], globals())
...
JNotLessEqualNLong = Instruction('JNotLessEqualNLong', 158, [Addr32, Reg8, Reg8], globals())
...
JGreaterEqualLong = Instruction('JGreaterEqualLong', 168, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqual = Instruction('JNotGreaterEqual', 169, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualLong = Instruction('JNotGreaterEqualLong', 170, [Addr32, Reg8, Reg8], globals())

JGreaterEqualN = Instruction('JGreaterEqualN', 171, [Addr8, Reg8, Reg8], globals())
JGreaterEqualNLong = Instruction('JGreaterEqualNLong', 172, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqualN = Instruction('JNotGreaterEqualN', 173, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualNLong = Instruction('JNotGreaterEqualNLong', 174, [Addr32, Reg8, Reg8], globals())
...
JStrictNotEqualLong = Instruction('JStrictNotEqualLong', 182, [Addr32, Reg8, Reg8], globals())
