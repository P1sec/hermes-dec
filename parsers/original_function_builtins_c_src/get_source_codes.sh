...
for git_tag in ${GIT_TAGS}; do
    ...
    if verlte "${git_tag}" "v0.3.0"; then
        wget -q "https://raw.githubusercontent.com/facebook/hermes/${git_tag}/include/hermes/Inst/Builtins.def" -O "Builtins-${git_tag}.def"
    else
        wget -q "https://raw.githubusercontent.com/facebook/hermes/${git_tag}/include/hermes/FrontEndDefs/Builtins.def" -O "Builtins-${git_tag}.def"
    fi
