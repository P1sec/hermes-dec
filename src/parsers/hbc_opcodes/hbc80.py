...
CreateClosureLongIndex = Instruction('CreateClosureLongIndex', 96, [Reg8, Reg8, UInt32], globals())

CreateGeneratorClosure = Instruction('CreateGeneratorClosure', 97, [Reg8, Reg8, UInt16], globals())

CreateGeneratorClosureLongIndex = Instruction('CreateGeneratorClosureLongIndex', 98, [Reg8, Reg8, UInt32], globals())
...
LoadConstStringLongIndex = Instruction('LoadConstStringLongIndex', 107, [Reg8, UInt32], globals())
...
GetArgumentsPropByVal = Instruction('GetArgumentsPropByVal', 118, [Reg8, Reg8, Reg8], globals())
...
CreateRegExp = Instruction('CreateRegExp', 121, [Reg8, UInt32, UInt32, UInt32], globals())
...
SwitchImm = Instruction('SwitchImm', 122, [Reg8, UInt32, Addr32, UInt32, UInt32], globals())
...
CreateGeneratorLongIndex = Instruction('CreateGeneratorLongIndex', 127, [Reg8, Reg8, UInt32], globals())
...
JNotLessEqualLong = Instruction('JNotLessEqualLong', 152, [Addr32, Reg8, Reg8], globals())
...
JNotLessEqualNLong = Instruction('JNotLessEqualNLong', 156, [Addr32, Reg8, Reg8], globals())
...
JGreaterEqualLong = Instruction('JGreaterEqualLong', 166, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqual = Instruction('JNotGreaterEqual', 167, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualLong = Instruction('JNotGreaterEqualLong', 168, [Addr32, Reg8, Reg8], globals())

JGreaterEqualN = Instruction('JGreaterEqualN', 169, [Addr8, Reg8, Reg8], globals())
JGreaterEqualNLong = Instruction('JGreaterEqualNLong', 170, [Addr32, Reg8, Reg8], globals())

JNotGreaterEqualN = Instruction('JNotGreaterEqualN', 171, [Addr8, Reg8, Reg8], globals())
JNotGreaterEqualNLong = Instruction('JNotGreaterEqualNLong', 172, [Addr32, Reg8, Reg8], globals())
...
JStrictNotEqualLong = Instruction('JStrictNotEqualLong', 180, [Addr32, Reg8, Reg8], globals())
