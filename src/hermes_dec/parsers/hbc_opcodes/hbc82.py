...
GetBuiltinClosure = Instruction(
    'GetBuiltinClosure', 86, [Reg8, UInt8], globals()
)

Ret = Instruction('Ret', 87, [Reg8], globals())

Catch = Instruction('Catch', 88, [Reg8], globals())

DirectEval = Instruction('DirectEval', 89, [Reg8, Reg8], globals())

Throw = Instruction('Throw', 90, [Reg8], globals())
...
CreateAsyncClosure = Instruction(
    'CreateAsyncClosure', 100, [Reg8, Reg8, UInt16], globals()
)

CreateAsyncClosureLongIndex = Instruction(
    'CreateAsyncClosureLongIndex', 101, [Reg8, Reg8, UInt32], globals()
)
...
LoadConstDouble = Instruction(
    'LoadConstDouble', 108, [Reg8, Double], globals()
)

LoadConstString = Instruction(
    'LoadConstString', 109, [Reg8, UInt16], globals()
)

LoadConstStringLongIndex = Instruction(
    'LoadConstStringLongIndex', 110, [Reg8, UInt32], globals()
)
...
GetArgumentsPropByVal = Instruction(
    'GetArgumentsPropByVal', 122, [Reg8, Reg8, Reg8], globals()
)

GetArgumentsLength = Instruction(
    'GetArgumentsLength', 123, [Reg8, Reg8], globals()
)

ReifyArguments = Instruction('ReifyArguments', 124, [Reg8], globals())

CreateRegExp = Instruction(
    'CreateRegExp', 125, [Reg8, UInt32, UInt32, UInt32], globals()
)
...
SwitchImm = Instruction(
    'SwitchImm', 126, [Reg8, UInt32, Addr32, UInt32, UInt32], globals()
)
...
CreateGenerator = Instruction(
    'CreateGenerator', 130, [Reg8, Reg8, UInt16], globals()
)

CreateGeneratorLongIndex = Instruction(
    'CreateGeneratorLongIndex', 131, [Reg8, Reg8, UInt32], globals()
)
...
JmpUndefinedLong = Instruction(
    'JmpUndefinedLong', 142, [Addr32, Reg8], globals()
)
...
JNotLessLong = Instruction(
    'JNotLessLong', 148, [Addr32, Reg8, Reg8], globals()
)
...
JNotEqualLong = Instruction(
    'JNotEqualLong', 180, [Addr32, Reg8, Reg8], globals()
)

JStrictEqual = Instruction('JStrictEqual', 181, [Addr8, Reg8, Reg8], globals())
JStrictEqualLong = Instruction(
    'JStrictEqualLong', 182, [Addr32, Reg8, Reg8], globals()
)

JStrictNotEqual = Instruction(
    'JStrictNotEqual', 183, [Addr8, Reg8, Reg8], globals()
)
JStrictNotEqualLong = Instruction(
    'JStrictNotEqualLong', 184, [Addr32, Reg8, Reg8], globals()
)
