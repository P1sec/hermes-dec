...
JmpUndefinedLong = Instruction(
    'JmpUndefinedLong', 137, [Addr32, Reg8], globals()
)
...
JNotLessLong = Instruction(
    'JNotLessLong', 143, [Addr32, Reg8, Reg8], globals()
)
...
JNotEqualLong = Instruction(
    'JNotEqualLong', 175, [Addr32, Reg8, Reg8], globals()
)

JStrictEqual = Instruction('JStrictEqual', 176, [Addr8, Reg8, Reg8], globals())
JStrictEqualLong = Instruction(
    'JStrictEqualLong', 177, [Addr32, Reg8, Reg8], globals()
)

JStrictNotEqual = Instruction(
    'JStrictNotEqual', 178, [Addr8, Reg8, Reg8], globals()
)
JStrictNotEqualLong = Instruction(
    'JStrictNotEqualLong', 179, [Addr32, Reg8, Reg8], globals()
)
