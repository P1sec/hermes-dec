...
ThrowIfUndefinedInst = Instruction(
    'ThrowIfUndefinedInst', 89, [Reg8], globals()
)

Debugger = Instruction('Debugger', 90, [], globals())

DebuggerCheckBreak = Instruction('DebuggerCheckBreak', 91, [], globals())
...
CreateClosure = Instruction(
    'CreateClosure', 94, [Reg8, Reg8, UInt16], globals()
)

CreateClosureLongIndex = Instruction(
    'CreateClosureLongIndex', 95, [Reg8, Reg8, UInt32], globals()
)

CreateGeneratorClosure = Instruction(
    'CreateGeneratorClosure', 96, [Reg8, Reg8, UInt16], globals()
)

CreateGeneratorClosureLongIndex = Instruction(
    'CreateGeneratorClosureLongIndex', 97, [Reg8, Reg8, UInt32], globals()
)
...
LoadConstDouble = Instruction(
    'LoadConstDouble', 104, [Reg8, Double], globals()
)

LoadConstString = Instruction(
    'LoadConstString', 105, [Reg8, UInt16], globals()
)

LoadConstStringLongIndex = Instruction(
    'LoadConstStringLongIndex', 106, [Reg8, UInt32], globals()
)
...
GetArgumentsPropByVal = Instruction(
    'GetArgumentsPropByVal', 117, [Reg8, Reg8, Reg8], globals()
)

GetArgumentsLength = Instruction(
    'GetArgumentsLength', 118, [Reg8, Reg8], globals()
)

ReifyArguments = Instruction('ReifyArguments', 119, [Reg8], globals())

CreateRegExp = Instruction(
    'CreateRegExp', 120, [Reg8, UInt32, UInt32, UInt32], globals()
)
...
SwitchImm = Instruction(
    'SwitchImm', 121, [Reg8, UInt32, Addr32, UInt32, UInt32], globals()
)
...
CreateGenerator = Instruction(
    'CreateGenerator', 125, [Reg8, Reg8, UInt16], globals()
)

CreateGeneratorLongIndex = Instruction(
    'CreateGeneratorLongIndex', 126, [Reg8, Reg8, UInt32], globals()
)
...
JmpUndefinedLong = Instruction(
    'JmpUndefinedLong', 134, [Addr32, Reg8], globals()
)
...
JNotLessLong = Instruction(
    'JNotLessLong', 140, [Addr32, Reg8, Reg8], globals()
)
...
JNotEqualLong = Instruction(
    'JNotEqualLong', 172, [Addr32, Reg8, Reg8], globals()
)

JStrictEqual = Instruction('JStrictEqual', 173, [Addr8, Reg8, Reg8], globals())
JStrictEqualLong = Instruction(
    'JStrictEqualLong', 174, [Addr32, Reg8, Reg8], globals()
)

JStrictNotEqual = Instruction(
    'JStrictNotEqual', 175, [Addr8, Reg8, Reg8], globals()
)
JStrictNotEqualLong = Instruction(
    'JStrictNotEqualLong', 176, [Addr32, Reg8, Reg8], globals()
)
