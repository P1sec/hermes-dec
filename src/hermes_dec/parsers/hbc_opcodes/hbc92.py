...
CreateInnerEnvironment = Instruction(
    'CreateInnerEnvironment', 51, [Reg8, Reg8, UInt32], globals()
)
...
ThrowIfHasRestrictedGlobalProperty = Instruction(
    'ThrowIfHasRestrictedGlobalProperty', 53, [UInt32], globals()
)

ThrowIfHasRestrictedGlobalProperty.operands[
    0
].operand_meaning = OperandMeaning.string_id

GetByIdShort = Instruction(
    'GetByIdShort', 54, [Reg8, Reg8, UInt8, UInt8], globals()
)

GetById = Instruction('GetById', 55, [Reg8, Reg8, UInt8, UInt16], globals())

GetByIdLong = Instruction(
    'GetByIdLong', 56, [Reg8, Reg8, UInt8, UInt32], globals()
)
...
TryGetById = Instruction(
    'TryGetById', 57, [Reg8, Reg8, UInt8, UInt16], globals()
)

TryGetByIdLong = Instruction(
    'TryGetByIdLong', 58, [Reg8, Reg8, UInt8, UInt32], globals()
)
...
PutByIdLong = Instruction(
    'PutByIdLong', 60, [Reg8, Reg8, UInt8, UInt32], globals()
)
...
TryPutById = Instruction(
    'TryPutById', 61, [Reg8, Reg8, UInt8, UInt16], globals()
)

TryPutByIdLong = Instruction(
    'TryPutByIdLong', 62, [Reg8, Reg8, UInt8, UInt32], globals()
)
...
PutNewOwnByIdShort = Instruction(
    'PutNewOwnByIdShort', 63, [Reg8, Reg8, UInt8], globals()
)

PutNewOwnById = Instruction(
    'PutNewOwnById', 64, [Reg8, Reg8, UInt16], globals()
)

PutNewOwnByIdLong = Instruction(
    'PutNewOwnByIdLong', 65, [Reg8, Reg8, UInt32], globals()
)
...
PutNewOwnNEById = Instruction(
    'PutNewOwnNEById', 66, [Reg8, Reg8, UInt16], globals()
)

PutNewOwnNEByIdLong = Instruction(
    'PutNewOwnNEByIdLong', 67, [Reg8, Reg8, UInt32], globals()
)
...
PutOwnByIndex = Instruction(
    'PutOwnByIndex', 68, [Reg8, Reg8, UInt8], globals()
)

PutOwnByIndexL = Instruction(
    'PutOwnByIndexL', 69, [Reg8, Reg8, UInt32], globals()
)

PutOwnByVal = Instruction(
    'PutOwnByVal', 70, [Reg8, Reg8, Reg8, UInt8], globals()
)
...
PutOwnGetterSetterByVal = Instruction(
    'PutOwnGetterSetterByVal', 76, [Reg8, Reg8, Reg8, Reg8, UInt8], globals()
)

GetPNameList = Instruction(
    'GetPNameList', 77, [Reg8, Reg8, Reg8, Reg8], globals()
)

GetNextPName = Instruction(
    'GetNextPName', 78, [Reg8, Reg8, Reg8, Reg8, Reg8], globals()
)
...
Call4 = Instruction(
    'Call4', 85, [Reg8, Reg8, Reg8, Reg8, Reg8, Reg8], globals()
)
...
ConstructLong = Instruction(
    'ConstructLong', 87, [Reg8, Reg8, UInt32], globals()
)
ConstructLong.has_ret_target = True

CallDirectLongIndex = Instruction(
    'CallDirectLongIndex', 88, [Reg8, UInt8, UInt32], globals()
)
...
CallBuiltinLong = Instruction(
    'CallBuiltinLong', 90, [Reg8, UInt8, UInt32], globals()
)

GetBuiltinClosure = Instruction(
    'GetBuiltinClosure', 91, [Reg8, UInt8], globals()
)
...
DirectEval = Instruction('DirectEval', 94, [Reg8, Reg8], globals())
...
CreateClosure = Instruction(
    'CreateClosure', 100, [Reg8, Reg8, UInt16], globals()
)

CreateClosureLongIndex = Instruction(
    'CreateClosureLongIndex', 101, [Reg8, Reg8, UInt32], globals()
)
...
CreateGeneratorClosure = Instruction(
    'CreateGeneratorClosure', 102, [Reg8, Reg8, UInt16], globals()
)

CreateGeneratorClosureLongIndex = Instruction(
    'CreateGeneratorClosureLongIndex', 103, [Reg8, Reg8, UInt32], globals()
)
...
CreateAsyncClosure = Instruction(
    'CreateAsyncClosure', 104, [Reg8, Reg8, UInt16], globals()
)

CreateAsyncClosureLongIndex = Instruction(
    'CreateAsyncClosureLongIndex', 105, [Reg8, Reg8, UInt32], globals()
)
...
LoadConstDouble = Instruction(
    'LoadConstDouble', 112, [Reg8, Double], globals()
)

LoadConstBigInt = Instruction(
    'LoadConstBigInt', 113, [Reg8, UInt16], globals()
)

LoadConstBigIntLongIndex = Instruction(
    'LoadConstBigIntLongIndex', 114, [Reg8, UInt32], globals()
)
...
LoadConstString = Instruction(
    'LoadConstString', 115, [Reg8, UInt16], globals()
)

LoadConstStringLongIndex = Instruction(
    'LoadConstStringLongIndex', 116, [Reg8, UInt32], globals()
)
...
GetArgumentsPropByVal = Instruction(
    'GetArgumentsPropByVal', 129, [Reg8, Reg8, Reg8], globals()
)

GetArgumentsLength = Instruction(
    'GetArgumentsLength', 130, [Reg8, Reg8], globals()
)

ReifyArguments = Instruction('ReifyArguments', 131, [Reg8], globals())

CreateRegExp = Instruction(
    'CreateRegExp', 132, [Reg8, UInt32, UInt32, UInt32], globals()
)
...
SwitchImm = Instruction(
    'SwitchImm', 133, [Reg8, UInt32, Addr32, UInt32, UInt32], globals()
)
...
CreateGenerator = Instruction(
    'CreateGenerator', 137, [Reg8, Reg8, UInt16], globals()
)

CreateGeneratorLongIndex = Instruction(
    'CreateGeneratorLongIndex', 138, [Reg8, Reg8, UInt32], globals()
)
...
JmpUndefinedLong = Instruction(
    'JmpUndefinedLong', 149, [Addr32, Reg8], globals()
)
...
JNotLessLong = Instruction(
    'JNotLessLong', 155, [Addr32, Reg8, Reg8], globals()
)
...
JNotEqualLong = Instruction(
    'JNotEqualLong', 187, [Addr32, Reg8, Reg8], globals()
)

JStrictEqual = Instruction('JStrictEqual', 188, [Addr8, Reg8, Reg8], globals())
JStrictEqualLong = Instruction(
    'JStrictEqualLong', 189, [Addr32, Reg8, Reg8], globals()
)

JStrictNotEqual = Instruction(
    'JStrictNotEqual', 190, [Addr8, Reg8, Reg8], globals()
)
JStrictNotEqualLong = Instruction(
    'JStrictNotEqualLong', 191, [Addr32, Reg8, Reg8], globals()
)
