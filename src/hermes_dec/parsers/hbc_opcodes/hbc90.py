...
LoadConstBigInt = Instruction(
    'LoadConstBigInt', 111, [Reg8, UInt16], globals()
)

LoadConstBigIntLongIndex = Instruction(
    'LoadConstBigIntLongIndex', 112, [Reg8, UInt32], globals()
)
...
LoadConstString = Instruction(
    'LoadConstString', 113, [Reg8, UInt16], globals()
)

LoadConstStringLongIndex = Instruction(
    'LoadConstStringLongIndex', 114, [Reg8, UInt32], globals()
)
...
GetArgumentsPropByVal = Instruction(
    'GetArgumentsPropByVal', 127, [Reg8, Reg8, Reg8], globals()
)

GetArgumentsLength = Instruction(
    'GetArgumentsLength', 128, [Reg8, Reg8], globals()
)

ReifyArguments = Instruction('ReifyArguments', 129, [Reg8], globals())

CreateRegExp = Instruction(
    'CreateRegExp', 130, [Reg8, UInt32, UInt32, UInt32], globals()
)
...
SwitchImm = Instruction(
    'SwitchImm', 131, [Reg8, UInt32, Addr32, UInt32, UInt32], globals()
)
...
CreateGenerator = Instruction(
    'CreateGenerator', 135, [Reg8, Reg8, UInt16], globals()
)

CreateGeneratorLongIndex = Instruction(
    'CreateGeneratorLongIndex', 136, [Reg8, Reg8, UInt32], globals()
)
...
JmpUndefinedLong = Instruction(
    'JmpUndefinedLong', 147, [Addr32, Reg8], globals()
)
...
JNotLessLong = Instruction(
    'JNotLessLong', 153, [Addr32, Reg8, Reg8], globals()
)
...
JNotEqualLong = Instruction(
    'JNotEqualLong', 185, [Addr32, Reg8, Reg8], globals()
)

JStrictEqual = Instruction('JStrictEqual', 186, [Addr8, Reg8, Reg8], globals())
JStrictEqualLong = Instruction(
    'JStrictEqualLong', 187, [Addr32, Reg8, Reg8], globals()
)

JStrictNotEqual = Instruction(
    'JStrictNotEqual', 188, [Addr8, Reg8, Reg8], globals()
)
JStrictNotEqualLong = Instruction(
    'JStrictNotEqualLong', 189, [Addr32, Reg8, Reg8], globals()
)
